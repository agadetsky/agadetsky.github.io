...
\begin{Detail}
\SubBulletItem
Description: conducting research on causal inference and\\ variance reduction techniques for discrete latent variable models.
\end{Detail}
...
\BulletItem
\href{https://yandex.com/scholarships/students}{Ilya Segalovich CS HSE Scholarship 2019}
\begin{Detail}
\Item
Description: Laureate
\end{Detail}
